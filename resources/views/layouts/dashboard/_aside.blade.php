    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if (auth()->user()->hasPermission('read_products'))
                <li><a href="{{ route('dashboard.products.index') }}"><i class="ion ion-stats-bars"></i><span>@lang('site.products')</span></a></li>
            @endif
            ...
            @if (auth()->user()->hasPermission('read_orders'))
                <li><a href="{{ route('dashboard.orders.index') }}"><i class="fa fa-file"></i><span>@lang('site.orders')</span></a></li>
            @endif
            ...
            @if (auth()->user()->hasPermission('read_users'))
            <li><a href="{{ route('dashboard.data') }}"><i class="fa fa-folder"></i><span>@lang('site.data')</span></a></li>
            @endif
